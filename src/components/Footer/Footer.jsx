...
const Footer = () => {
  ...
  return (
    <footer className="text-white px-4 py-5 max-w-screen-xl mx-auto md:px-8 mt-16">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                        <p className='font-lg text-bold tracking-wide'>NitianBit</p>
                    ...
                    >
                        ...
                        <div className="max-w-sm flex items-centerrounded-md p-1">
                            <input 
                                type="email"
                ...
                <div className="flex-1 mt-10 space-y-6 items-center justify-between sm:flex md:space-y-0 md:mt-0">
                    {
                        footerNavs.map((item, idx) => (
                            <ul
                                ...
                                key={idx}
                            >
                                <h4 className="text-white font-bold border-b">
                                    { item.label }
                                </h4>
                                {
